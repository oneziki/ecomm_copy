...
function Checkout({ cart, setResponse, setCart, handleChange }) {
              ...
              <div class="row">
                <div class="col-md-12 p-5">
                  ...
                  <div style={{marginBottom: "30px"}}>
                    <div>
                      <form className="form-inline" ref={formRef} style={{maxWidth: "460px"}}>
                        ...
                        <input
                          ...
                          style={{
                            ...
                            padding: "15px",
                            borderRadius: "8px",
                            border: "solid #8080805c",
                            color: "grey",
                          }}
                        />
                        <br />
                        <label
                          className="my-1 mr-2 pt-4"
                        ...
                        <select
                          ...
                          className="custom-select my-1 mr-sm-2 customDropdown"
                          id="inlineFormCustomSelectPref"
                        >
                          <option id="opt" value="" hidden>
                            Select
                          </option>
                          <option style={{}} value="phone">SMS</option> <br />
                    ...
                    {spinner && (
                      <Page loader={"spin"} color={"#b2fa00"} size={4}></Page>
                    )}
                  </div>

                  <div>{cart.length === 0 && <div>Cart is empty</div>}</div>

                  {/* This is the cart Items container */}
                  <div>
                    {cart.map((item) => (
